        ...
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="section-shell rounded-[2rem] p-8">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                {statusOptions.map((status) => (
                  <button key={status} type="button" onClick={() => updateStatus(status)} disabled={isUpdating} className="btn btn-outline btn-sm type-button disabled:cursor-not-allowed disabled:opacity-70">
                    {status}
                  </button>
                ))}
              </div>
          ...
          <div className="space-y-6">
            <div className="section-shell rounded-[2rem] p-8">
              ...
              />
              <button type="button" onClick={saveNotes} disabled={isUpdating} className="btn btn-primary btn-md type-button mt-4 disabled:cursor-not-allowed disabled:opacity-70">
                Save Notes
              </button>
            </div>
