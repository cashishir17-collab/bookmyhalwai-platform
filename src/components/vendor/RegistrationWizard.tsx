  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const vendorDoc = {
        ...
        primaryCategory: form.providerCategory,
        categorySlug: form.providerCategory,
        categories: [form.providerCategory],
        ...
        serviceLocations: form.areasServed.split(",").map((area) => area.trim()).filter(Boolean),
        ...
        serviceTypes: form.categoryServices,
